...
my @dr4 = (9, 10, 11, 12, 13, 58, 70, 71, 74);
my @dr7 = (9, 10, 11, 12, 13, 14, 60, 74);	# added residue 60S that is immunogenic
my @dr8 = (9, 10, 11, 12, 13, 58, 74);
my @dr818 = (9, 10, 11, 12, 13, 47, 58, 60, 71, 74);	# need to distinguish from DR12
my @dr9 = (9, 10, 11, 12, 13, 60, 74);	#60S is included. See DR7
my @dr10 = (9, 10, 11, 12, 13);
my @dr11 = (9, 10, 11, 12, 13, 58, 70, 71);	# 70, 71 were added to distinguish DR1102
my @dr12 = (9, 10, 11, 12, 13, 47, 58, 60, 71, 74);	# residue 71 is required to distinguish from DR1317
my @dr13 = (9, 10, 11, 12, 13, 58, 60, 70, 71, 74);	# residue 58 is required to distinguish from DR11 & DR1102
my @dr14 = (9, 10, 11, 12, 13, 16, 58, 60, 70, 71, 74);
my @dr1405 = (9, 10, 11, 12, 13, 16, 58, 60, 70, 71, 74);
my @dr1403 = (9, 10, 11, 12, 13, 58, 60, 70, 71, 74);
my @dr15 = (9, 10, 11, 12, 13, 70);
my @dr16 = (9, 10, 11, 12, 13, 70);
...
my %dr1107;
$dr1107{"DR-1107"} = "HLA00760";		# DRB1*11:07:01
$group{"DR-1107"} = "DR1107";
$base{"DR-1107"} = "DR11";
push @subtype, ("DR-1107");
my %dr4;
...
$group{"DR-1101"} = "DR11"; $group{"DR-1102"} = "DR11"; $group{"DR-1105"} = "DR11"; $group{"DR-1117"} = "DR11";
$base{"DR-1101"} = "DR11"; $base{"DR-1102"} = "DR11"; $base{"DR-1105"} = "DR11"; $base{"DR-1117"} = "DR11";
push @subtype, ("DR-1102","DR-1105","DR-1117");
...
$group{"DR-1301"} = "DR13"; $group{"DR-1303"} = "DR13"; $group{"DR-1305"} = "DR13"; $group{"DR-1317"} = "DR13";
$base{"DR-1301"} = "DR13"; $base{"DR-1303"} = "DR13"; $base{"DR-1305"} = "DR13"; $base{"DR-1317"} = "DR13";

my %dr1339;
$dr1339{"DR-1339"} = "HLA01166";		# DRB1*13:39
$dr1339{"DR-1343"} = "HLA01237";		# DRB1*13:43
$group{"DR-1339"} = "DR1339"; $group{"DR-1343"} = "DR1339";
$base{"DR-1339"} = "DR13"; $base{"DR-1343"} = "DR13";
push @subtype, ("DR-1303","DR-1305","DR-1317","DR-1339","DR-1343");

my %dr14;
$dr14{"DR-1454"} = "HLA02371";		# DRB1*14:54:01:01
...
$group{"DR-1454"} = "DR14"; $group{"DR-1402"} = "DR14"; $group{"DR-1404"} = "DR14"; $group{"DR-1414"} = "DR14"; $group{"DR-1411"} = "DR14"; $group{"DR-1419"} = "DR14";
$base{"DR-1454"} = "DR14"; $base{"DR-1402"} = "DR14"; $base{"DR-1404"} = "DR1404"; $base{"DR-1414"} = "DR14"; $base{"DR-1411"} = "DR1404"; $base{"DR-1419"} = "DR14";
my %dr1403;
$dr1403{"DR-1403"} = "HLA00835";		# DRB1*14:03:01
$dr1403{"DR-1424"} = "HLA00856";		# DRB1*14:24
$dr1403{"DR-1448"} = "HLA01734";		# DRB1*14:48
$group{"DR-1403"} = "DR1403";  $group{"DR-1424"} = "DR1403"; $group{"DR-1448"} = "DR1403";
$base{"DR-1403"} = "DR1403"; $base{"DR-1424"} = "DR14"; $base{"DR-1448"} = "DR14";
my %dr1405;
$dr1405{"DR-1405"} = "HLA00837";		# DRB1*14:05:01:01
$group{"DR-1405"} = "DR1405";
$base{"DR-1405"} = "DR14";
my %dr1422;
$dr1422{"DR-1422"} = "HLA00854";		# DRB1*14:22
$group{"DR-1422"} = "DR1422";
$base{"DR-1422"} = "DR14";
push @subtype, ("DR-1402","DR-1403","DR-1404","DR-1405","DR-1414","DR-1422","DR-1411","DR-1424","DR-1448","DR-1419");	# modify here if serotype modified
...
sub RESIDUES {
	...
	push @combined, @dr13;
	push @combined, @dr14;
	push @combined, @dr1403;
	push @combined, @dr1405;
	push @combined, @dr15;
	push @combined, @dr16;
	my %seen;
	my @unique;
	...
	elsif ( $serotype eq "DR1107" ) {	# DR1107 & DR308 are identical
		@residues = @dr11;
	}
	...
	elsif ( $serotype eq "DR1339" ) {
		@residues = @dr13;
	}
	elsif ( $serotype eq "DR1343" ) {
		@residues = @dr13;
	}
	elsif ( $serotype eq "DR14" ) {
		@residues = @dr14;
	}
	elsif ( $serotype eq "DR1403" ) {
		@residues = @dr1403;
	}
	elsif ( $serotype eq "DR1405" ) {
		@residues = @dr1405;
	}
	elsif ( $serotype eq "DR1422" ) {
		@residues = @dr14;
	}
...
sub REF {
	...
	if ( $serotype eq "DR1" ) {
	...
	elsif ( $serotype eq "DR1107" ) {	 #"DR308"
		%ref = %dr1107;
	}
	elsif ( $serotype eq "DR4" ) {
		%ref = %dr4;
		...
		%ref = (%dr1,%dr3,%dr1107,%dr4,%dr7,%dr8,%dr818,%dr9,%dr10,%dr11,%dr12,%dr13,%dr1339,
		%dr14,%dr1403,%dr1405,%dr1422,%dr15,%dr16);
	}
...
sub SERO {
	my @sero;
	my %ref = (%dr1,%dr3,%dr1107,%dr4,%dr7,%dr8,%dr818,%dr9,%dr10,%dr11,%dr12,%dr13,%dr1339,
	%dr14,%dr1403,%dr1405,%dr1422,%dr15,%dr16);
...
sub KEY {
	my %tmp = (%dr1,%dr3,%dr1107,%dr4,%dr7,%dr8,%dr818,%dr9,%dr10,%dr11,%dr12,%dr13,%dr1339,
	%dr14,%dr1403,%dr1405,%dr1422,%dr15,%dr16);
	my %ref;
	my $key_ref = \%ref;
...
sub PARTIAL {		# partial sequence
	...
	$partial{ "DR-1419"} = "N" x 29;	# full length as of 3.44.0
